...
{ id: 'kashi-vishwanath-jyotirlinga', name: 'Kashi Vishwanath Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'trimbakeshwar-jyotirlinga', name: 'Trimbakeshwar Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'vaidyanath-jyotirlinga', name: 'Vaidyanath (Baidyanath) Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'nageshwar-jyotirlinga', name: 'Nageshwar Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'ramanathaswamy-jyotirlinga', name: 'Ramanathaswamy Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'grishneshwar-jyotirlinga', name: 'Grishneshwar Jyotirlinga', country: 'India', type: 'jyotirlinga' },
{ id: 'kashi-vishwanath', name: 'Kashi Vishwanath Temple', country: 'India', type: 'temple' },
{ id: 'somnath-temple', name: 'Somnath Temple', country: 'India', type: 'temple' },
{ id: 'shree-siddhivinayak', name: 'Shree Siddhivinayak Temple', country: 'India', type: 'temple' },
{ id: 'vaishno-devi', name: 'Vaishno Devi Temple', country: 'India', type: 'temple' },
{ id: 'tirupati-balaji', name: 'Tirupati Balaji Temple', country: 'India', type: 'temple' },
{ id: 'meenakshi-temple', name: 'Meenakshi Amman Temple', country: 'India', type: 'temple' },
{ id: 'kamakhya-temple', name: 'Kamakhya Devi Temple', country: 'India', type: 'temple' },
{ id: 'shirdi-sai-baba', name: 'Shirdi Sai Baba Temple', country: 'India', type: 'temple' },
{ id: 'akshardham-delhi', name: 'Akshardham Temple (Delhi)', country: 'India', type: 'temple' },
{ id: 'akshardham-gandhinagar', name: 'Akshardham Temple (Gandhinagar)', country: 'India', type: 'temple' },
{ id: 'jagannath-temple', name: 'Jagannath Temple (Puri)', country: 'India', type: 'temple' },
{ id: 'dwarkadhish-temple', name: 'Dwarkadhish Temple', country: 'India', type: 'temple' },
{ id: 'rameshwaram-temple', name: 'Ramanathaswamy Temple (Rameshwaram)', country: 'India', type: 'temple' },
{ id: 'padmanabhaswamy-temple', name: 'Padmanabhaswamy Temple', country: 'India', type: 'temple' },
{ id: 'sabarimala', name: 'Sabarimala Temple', country: 'India', type: 'temple' },
{ id: 'banke-bihari', name: 'Banke Bihari Temple (Vrindavan)', country: 'India', type: 'temple' },
{ id: 'iskcon-vrindavan', name: 'ISKCON Temple (Vrindavan)', country: 'India', type: 'temple' },
{ id: 'kalkaji-temple', name: 'Kalkaji Temple', country: 'India', type: 'temple' },
{ id: 'mahalaxmi-mumbai', name: 'Mahalaxmi Temple (Mumbai)', country: 'India', type: 'temple' },
{ id: 'lalbaugcha-raja', name: 'Lalbaugcha Raja Ganesh Mandal', country: 'India', type: 'temple' },
{ id: 'dakshineswar-temple', name: 'Dakshineswar Kali Temple', country: 'India', type: 'temple' },
{ id: 'kalighat-temple', name: 'Kalighat Kali Temple', country: 'India', type: 'temple' },
{ id: 'maa-tara-tarapeeth', name: 'Maa Tara Temple (Tarapeeth)', country: 'India', type: 'temple' },
{ id: 'lohagarh-temple', name: 'Lohagarh Hanuman Temple', country: 'India', type: 'temple' },
{ id: 'pashupatinath-temple', name: 'Pashupatinath Temple (Mandsaur)', country: 'India', type: 'temple' },
{ id: 'omkareshwar-temple', name: 'Omkareshwar Temple', country: 'India', type: 'temple' },
{ id: 'mahakaleshwar-temple', name: 'Mahakaleshwar Temple (Ujjain)', country: 'India', type: 'temple' },
{ id: 'grishneshwar-temple', name: 'Grishneshwar Jyotirlinga Temple', country: 'India', type: 'temple' },
...
{ id: 'nicobar', name: 'Nicobar Islands', country: 'India', type: 'union territory' },
...
const Booking = ({ addBooking }) => {
  ...
  const fetchFlights = async () => {
    ...
    const dummyFlights = [
      ...
      {
       id: 3,
airline: isInternational ? "Singapore Airlines" : "SpiceJet",
flightNumber: isInternational ? "SQ-789" : "SG-789",
departure: "16:30",
arrival: isInternational ? "20:00" : "19:15",
